...
DISCRYPT_PUBLIC_MQTT_E2E=1 DISCRYPT_PUBLIC_MQTT_ENDPOINT=mqtts://broker.emqx.io:8883 cargo test -q -p discrypt-transport --features mqtt-adapter --test public_signaling_e2e public_mqtt_two_peer_presence_and_signal_roundtrip -- --nocapture
