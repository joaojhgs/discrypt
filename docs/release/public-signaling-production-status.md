...
- [ ] Complete IPFS/libp2p production hardening:
  ...
  - map remaining libp2p bootstrap/resource/message failures to typed health beyond the current `topic_mesh_unavailable`, invalid/duplicate/overflow profile rejection, and max-message local rejection,
