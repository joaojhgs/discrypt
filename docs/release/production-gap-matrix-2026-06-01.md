...
| G004 Persistence and invite policy correctness | Partial | Verify and fill persistence for identity/recovery, DMs, groups, channels, invites, adapter/ICE config, messages, receipts, voice prefs, UI prefs across restarts for two profiles. | Restart-based tests using isolated app data dirs. |
