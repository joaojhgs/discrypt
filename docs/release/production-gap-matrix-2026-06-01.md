...
- G011 and G012 stay separate: G011 can close only after integrated production-readiness gates pass and final evidence is retained; G012 still requires the real two-installed-user Tauri text-plus-voice artifact bundle.
