...
| G010 Release harness and automation | Partial | Adapter/public matrix automation is wired through `npm --prefix apps/ui run test:g010-adapter-public-matrix` with deterministic local STUN/overlay/TURN gates and explicit env-gated MQTT/Nostr/IPFS/QUIC/TURN skips; real Tauri two-user harness work remains separate. | Reproducible script command and archived artifacts; no G011/G012 final production claim. |
