...
fn main() {
    ...
    match (
        ...
        (
            ...
            media.capture_opus_sframe_protected,
            media.receive_decode_jitter_playback_ready,
            media.mute_suppresses_outbound_media,
            ...
            voice_e2e.turn_required_audio_exchanged,
            ...
            text.turn_required_path_text_exchanged,
