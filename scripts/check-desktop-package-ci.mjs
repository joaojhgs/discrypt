...
for (const token of [
  ...
  "cargo deny --version",
  "cargo sbom --version",
  "Test password vault reinstall durability",
  "production_passphrase_vault_app_db_survives_fresh_instance_with_same_password",
  "existing_encrypted_app_db_missing_vault_key_fails_closed_without_overwrite",
