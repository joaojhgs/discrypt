...
for (const token of ['test:adr-008-supply-chain', 'test:sbom-g124', 'test:no-placeholders-g127', 'test:placeholder-allowlist-g128', 'test:release-no-fallback-g129']) requireText('packageJson', token);
