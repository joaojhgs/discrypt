...
for (const token of ["test:reproducible-g126", "repro:g126"]) requireText("package.json", packageJson, token);
...
for (const token of ["test:reproducible-g126", "Release build can be reproduced from lockfiles and documented toolchain versions"]) requireText("ADR-008", adr, token);
