...
const required = [
  ...
  ['ADR covers CURRENT_SCHEMA_DDL', contents.adr, 'CURRENT_SCHEMA_DDL'],
  ...
  ['appdb has current-schema DDL', contents.appdb, 'CURRENT_SCHEMA_DDL'],
...
const commands = [
  ...
  ['cargo', ['test', '-p', 'discrypt-storage', 'migration_planner_rejects_pre_current_existing_schema', '--quiet']],
