...
const expectedCommands = [
  ...
  {
    command: "set_connectivity_policy",
    exportName: "setConnectivityPolicy",
    args: [
      "scope_kind",
      "group_id",
      "channel_id",
  ...
  },
  {
    ...
    args: ["name", "retention", "admission_mode"],
    returns: "AppState",
  },
  {
  ...
  {
    command: "set_group_admission_mode",
    exportName: "setGroupAdmissionMode",
    args: ["group_id", "admission_mode"],
    returns: "AppState",
  },
  {
    command: "approve_group_admission_request",
    exportName: "approveGroupAdmissionRequest",
    args: ["group_id", "request_id"],
    returns: "AppState",
  },
  {
    command: "refuse_group_admission_request",
    exportName: "refuseGroupAdmissionRequest",
    args: ["group_id", "request_id", "reason"],
    returns: "AppState",
  },
  {
    command: "promote_group_member_to_staff",
    exportName: "promoteGroupMemberToStaff",
    args: ["group_id", "member_id"],
    returns: "AppState",
  },
  {
    command: "demote_group_staff_to_member",
    exportName: "demoteGroupStaffToMember",
    args: ["group_id", "member_id"],
    returns: "AppState",
  },
  {
    command: "revoke_group_member_access",
    exportName: "revokeGroupMemberAccess",
    args: ["group_id", "member_id", "reason"],
    returns: "AppState",
  },
  {
    command: "publish_group_presence",
    exportName: "publishGroupPresence",
    args: ["group_id", "member_id", "ttl_seconds"],
    returns: "AppState",
  },
  {
  ...
  {
    command: "attach_voice_remote_media",
    exportName: "attachVoiceRemoteMedia",
    args: [
      "session_id",
      "participant_id",
      "participant_name",
...
const requestTypes = [
  ...
  ["CreateGroupRequest", ["name", "retention", "admission_mode"]],
  ["JoinGroupRequest", ["invite_code", "group_name"]],
  ["PromoteGroupMemberRequest", ["group_id", "member_id"]],
  ...
  [
    "GroupRolePolicyView",
    ["admission_mode", "policy_epoch", "updated_by", "updated_at"],
  ],
  [
