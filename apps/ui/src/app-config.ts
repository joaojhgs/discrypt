...
export const discryptUiConfig = {
  ...
  themes: [
    {
      ...
      description: 'Default: quiet Discord-like dark chrome with restrained cyan accents.',
      cssVars: {
        '--background': '222 47% 5%',
    ...
    },
    {
      id: 'graphite-calm',
      label: 'Graphite calm',
      description: 'Lower-saturation professional dark UI for less glow and more editorial quiet.',
      cssVars: {
        '--background': '220 18% 6%',
    ...
    },
    {
      ...
      description: 'More contrast for demos while keeping the same single-accent rule.',
      cssVars: {
        '--background': '215 54% 4%',
  ...
  templates: [
    { id: 'command-center', label: 'Command center', density: 'comfortable', radius: 'soft', showRightRail: true },
    { id: 'compact-ops', label: 'Compact ops', density: 'compact', radius: 'crisp', showRightRail: true },
...
export const activityFeed = [
  ...
  'Relay route carries ciphertext only',
